...
| **Saga Replay & Time-Travel** | 1.5.0 | ✅ Done — [ADR-024](architecture/adr/adr-024-saga-replay.md) |
| **Dead Letter Queue (DLQ)** | 1.5.0 | ✅ Done — [#44](https://github.com/brunolnetto/sagaz/issues/44) |
| **SQLite Backend** | 1.6.0 | ✅ Done — [#46](https://github.com/brunolnetto/sagaz/issues/46) |
| **Storage Migration Layer** | 1.6.0 | ✅ Done — [#47](https://github.com/brunolnetto/sagaz/issues/47) |
| **GitFlow Compliance** | 1.6.0 | ✅ Done — Automated PR validation |
...
|---------|------|------------|
| 1.6.0 | 2026-04 | Core Storage refactor, SQLite backend, CLI tests |
| 1.5.0 | 2026-04 | Saga Replay & Time-Travel (ADR-024), DLQ pattern |
| 1.4.0 | 2026-01 | Context Streaming (ADR-021), 24 industry examples |
| 1.3.0 | 2026-01 | Pivot Steps, Event Triggers, Dry-Run, CLI scaffold |
| 1.2.0 | 2026-01 | Unified Storage Layer, Compensation Result Passing |
