...
Core Infrastructure (v1.2.0+):
    >>> from sagaz.core.storage.core import StorageError, HealthStatus, serialize
    >>> from sagaz.core.storage.interfaces import SagaStorage, OutboxStorage, Transferable
"""
