...
async def successful_etl_demo():
    ...
    print("\n" + "=" * 80)
    print("📊 ETL Pipeline Saga - Successful Execution Demo")
    print("=" * 80)
    ...
    print(f"\n{'✅' if result.get('saga_id') else '❌'} ETL Pipeline Result:")
...
async def failed_etl_demo():
    ...
    print("\n" + "=" * 80)
    print("⚠️  ETL Pipeline Saga - Failure with Automatic Rollback Demo")
    print("=" * 80)
    ...
    for attempt in range(3):
        try:
            ...
            print(f"\n✅ Attempt {attempt + 1} succeeded: {result.get('saga_id')}")
        except SagaStepError as e:
            print(f"\n❌ Attempt {attempt + 1} failed: {e}")
            print("   ✅ Automatic compensation completed")
...
async def main():
    ...
    print("  ✅ Automatic staging table cleanup on failure")
    print("  ✅ Warehouse partition rollback")
    print("  ✅ Catalog consistency maintained")
    print("  ✅ Full audit trail with structured logging")
    print("  ✅ Reusable saga for different data sources")
