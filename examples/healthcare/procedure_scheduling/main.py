...
async def main():
    print("=" * 80)
    print("🏥 Medical Procedure Scheduling Saga Demo")
    print("=" * 80)
    ...
    print(f"\n✅ Scheduling Result:")
    print(f"   Confirmation: {result.get('confirmation_id', 'N/A')}")
    print(f"   OR Room: {result.get('or_room', 'N/A')}")
    print(f"   Surgeon: {result.get('surgeon', 'N/A')}")
