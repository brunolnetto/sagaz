...
from sagaz.cli_examples import (
    get_examples_dir,
    get_categories,
    discover_examples,
...
class TestGetCategories:
    ...
    @patch("sagaz.cli_examples.get_examples_dir")
...
class TestListExamplesCmd:
    ...
    @patch("sagaz.cli_examples.discover_examples")
    @patch("sagaz.cli_examples.console")
    ...
    @patch("sagaz.cli_examples.discover_examples")
    @patch("sagaz.cli_examples.console")
    @patch("sagaz.cli_examples.Table")
    ...
    @patch("sagaz.cli_examples.discover_examples")
    @patch("sagaz.cli_examples.get_categories")
...
class TestRunExampleCmd:
    ...
    @patch("sagaz.cli_examples.discover_examples")
    @patch("sagaz.cli_examples._execute_example")
    @patch("click.echo")
...
class TestInteractiveCmd:
    ...
    @patch("sagaz.cli_examples.TERM_MENU_AVAILABLE", False)
    @patch("sagaz.cli_examples.discover_examples")
    @patch("click.echo")
    ...
    @patch("sagaz.cli_examples.TERM_MENU_AVAILABLE", False)
    @patch("sagaz.cli_examples.discover_examples")
    @patch("sagaz.cli_examples._fallback_interactive_simple")
    ...
    @patch("sagaz.cli_examples.TERM_MENU_AVAILABLE", True)
    @patch("sagaz.cli_examples._category_menu_loop")
    ...
    @patch("sagaz.cli_examples.TERM_MENU_AVAILABLE", True)
    @patch("sagaz.cli_examples._examples_menu_loop")
...
class TestFallbackInteractive:
    ...
    @patch("click.prompt")
    @patch("click.echo")
    @patch("sagaz.cli_examples.get_example_description")
